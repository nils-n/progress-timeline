...
})({"j74K9":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7c8a2cfda655cc56";
"use strict";
...
},{}],"fD13P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createStory", ()=>createStory);
parcelHelpers.export(exports, "displayStories", ()=>displayStories);
parcelHelpers.export(exports, "handleLikeButton", ()=>handleLikeButton);
var _firebase = require("./firebase");
const createStory = async (title, content, decade, publishDate)=>{
    const user = (0, _firebase.firebaseAuth).currentUser;
    if (user) try {
        const storyRef = (0, _firebase.doc)((0, _firebase.firebaseDB), "stories", generateUniqueID());
        const newStory = {
            title,
            content,
            author: user.email,
        ...
        await (0, _firebase.setDoc)(storyRef, newStory);
...
const displayStories = async ()=>{
    ...
    try {
        const storiesSnapshot = await (0, _firebase.getDocs)(collection((0, _firebase.firebaseDB), "stories"));
...
const handleLikeButton = async (storyId)=>{
    const storyRef = (0, _firebase.doc)((0, _firebase.firebaseDB), "stories", storyId);
    try {
        ...
        if (user && storyData.likedBy && storyData.likedBy.includes(user.uid)) {
            ...
            await (0, _firebase.updateDoc)(storyRef, {
                likeCounter: storyData.likeCounter - 1,
                likedBy: (0, _firebase.arrayRemove)(user.uid)
            });
            ...
            await (0, _firebase.updateDoc)(storyRef, {
                likeCounter: storyData.likeCounter + 1,
                likedBy: (0, _firebase.arrayUnion)(user.uid)
            });
...
},{"./firebase":"38sjH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j74K9","fD13P"], "fD13P", "parcelRequire2d45")

//# sourceMappingURL=index.a655cc56.js.map
