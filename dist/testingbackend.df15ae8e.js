...
parcelHelpers.export(exports, "createUserDocumentFromAuth", ()=>createUserDocumentFromAuth);
...
const userSignUp = async ()=>{
    ...
    try {
        const { user  } = await (0, _auth.createUserWithEmailAndPassword)((0, _firebaseConfig.firebaseAuth), signUpEmail, signUpPassword);
...
const userSignIn = async ()=>{
    ...
    try {
        (0, _auth.signInWithEmailAndPassword)((0, _firebaseConfig.firebaseAuth), signInEmail, signInPassword);
...
const signInWithGoogle = async ()=>{
    ...
    try {
        const result = await (0, _auth.signInWithPopup)((0, _firebaseConfig.firebaseAuth), provider);
...
const createUserDocumentFromAuth = async (userAuth)=>{
    if (!userAuth) return;
    const userDocRef = (0, _firestore.doc)((0, _firebaseConfig.firebaseDB), "users", userAuth.uid);
    const userSnapShot = await (0, _firestore.getDoc)(userDocRef);
    if (!userSnapShot.exists()) {
        const { email  } = userAuth;
        const createAt = new Date();
        try {
            await (0, _firestore.setDoc)(userDocRef, {
                email,
                createAt
            });
        } catch (err) {
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dmexu","biPfD"], "biPfD", "parcelRequire2d45")

//# sourceMappingURL=testingbackend.df15ae8e.js.map
