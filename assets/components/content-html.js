...
<div class="home-year-container">
  <h2 class="home-text05 h2">1967</h2>
</div>
...
<div class="home-event-text-container">
  <div class="home-container12">
    <span class="home-text06">Resistance</span>
...
<div id="user-story-modal" class="home-user-modal-container">
  <h2 id="your-stories-left" class="home-text08">
    Your storIES
  </h2>
  <div id="input-story-form" class="home-testimonial-card">
    <div class="home-testimonial">
      ...
      <span class="home-text09">
        ...
        accumsan ipsum.Lorem ipsum dolor sit amet, consectetur
        adipiscing elit. In lorem lorem, malesuada in metus
        vitae, scelerisque accumsan ipsum.
      </span>
      <div class="home-like-container">
        <div class="home-container13">
          <span
            id="your-stories-like-count"
            class="home-text10"
          >
